...
export default function newRec( { data } ) {
    ...
    return (
      <Container maxWidth='sm'>
          ...
          <TextField id="lastname_tf" label="Επώνυμο" variant="standard" value={gtUser.last_name} onChange={e =>onChange(e, "last_name")} />
          <br />
          <TextField id="firstname_tf" label="Όνομα" variant="standard" value={gtUser.first_name} onChange={e =>onChange(e, "first_name")}/>
          <br />
          <br />
          <FormControl component="fieldset">
            <FormLabel id="active" component="legend">Είναι Ενεργός?</FormLabel>
            <RadioGroup row aria-label="active" name="row-radio-buttons-group" value={gtUser.is_active}>
                <FormControlLabel value="true" control={<Radio />} label="Ναι"  onChange={e =>onChange(e, "is_active")} onClick={() => setSelection('TRUE') } />
                <FormControlLabel value="false" control={<Radio />} label="Όχι" onChange={e =>onChange(e, "is_active")} onClick={() => setSelection('FALSE')} />
            </RadioGroup>
          </FormControl>
          <br />
